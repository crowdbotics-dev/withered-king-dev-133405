"""
Django settings for withered_king_dev_133405 project.
...
ROOT_URLCONF = 'withered_king_dev_133405.urls'
...
WSGI_APPLICATION = 'withered_king_dev_133405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_king_dev_133405 API",
    "DESCRIPTION": "API documentation for withered_king_dev_133405 App",
    "VERSION": "v1",
}
